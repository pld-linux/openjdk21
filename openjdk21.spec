...
OpenJDK components including the OpenJDK, Java 21 developement kit and
runtime environment.

%description -l pl.UTF-8
Wolnoźródłowa implementacja Java 21 SE.
...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk21-jdk < 21.0.11
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk21-jdk-base < 21.0.11
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk21-jre < 21.0.11
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk21-jre-base < 21.0.11
...
Obsoletes:	openjdk21-jre-base-X11 < 21.0.11
...
Obsoletes:	openjdk21-jre-base-freetype < 21.0.11
...
Obsoletes:	jar
Obsoletes:	openjdk21-jar < 21.0.11
